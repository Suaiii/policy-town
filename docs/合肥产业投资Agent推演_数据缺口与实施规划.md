...
当前数据足以验证数据库结构、信息截止查询和部分项目资金压力，但不足以开展可信的 2007—2016 全周期 Agent Replay。不能把“有财政总账”误读成“知道可投资余额”：目前缺财政结余、国资平台现金流、产业基金可用余额、项目实缴/提款流水和完整项目承诺。最主要的阻塞项不是模型，而是财政约束、产业年度序列、企业年度财务和来源元数据。
...
| 优先级 | 缺口 | 对推演的影响 |
|---|---|---|
| P0 | 合肥 2007—2016 财政、税收、土地出让、国资和债务 | 可判断财政环境，但无法还原全市可自由支配余额，也无法完整判断单个项目对财政的占用 |
| P0 | 国资平台现金流、项目实缴/提款、政府资本承诺兑现 | 已有京东方项目级承诺证据，但仍不能把承诺额当作可用现金或年度新增额度 |
