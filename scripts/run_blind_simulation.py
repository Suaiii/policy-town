...
from contracts.investment_simulation_v0_1 import StageId
...
def main() -> None:
    ...
    results = []
    for company_id in ("company_a", "company_d"):
        result = run_blind_decision(
            engine, state, stage_id=StageId.S1, seed=42, company_id=company_id,
        )
